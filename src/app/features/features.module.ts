...
const routes: Routes = [
  ...
  {path: 'problemi-trattati/dipendenza-sessuale', component: DipendenzaSessualeComponent},
  {path: 'problemi-trattati/dipendenza-da-internet', component: DipendenzaDaInternetComponent},
  {path: 'problemi-trattati/disturbi-del-comportamento-alimentare', component: DisturbiDelComportamentoAlimentareComponent},
  {path: 'problemi-trattati/dipendenza-affettiva', component: DipendenzaAffettivaComponent},
  {path: 'problemi-trattati/dipendenza-da-sostanze', component: DipendenzaDaSostanzeComponent},
  {path: 'problemi-trattati/adoloscenza-e-genitorialita', component: AdolescenzaEGenitorialitaComponent},
